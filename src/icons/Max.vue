<template>
    <svg t="1733119694368" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
        p-id="21652" width="100%" height="100%">
        <path
