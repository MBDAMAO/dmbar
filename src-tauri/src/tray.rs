...
pub fn create_tray<R: Runtime>(app: &tauri::AppHandle<R>) -> tauri::Result<()> {
    ...
    // Dynamic data for the tooltip
    let app_name = "My Tauri App";
    let app_description = "This is a cross-platform app.";
    let more_info = "Click to interact.";

    // Use format! to create the multi-line tooltip
    let tooltip = format!(
        "{}\n{}\n{}",    // Format string with newlines
        app_name,        // First line
        app_description, // Second line
        more_info,       // Third line
    );
